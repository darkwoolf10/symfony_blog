    ...
    public function provideInvalidConfiguration()
    {
        return array(
            ...
            'missing default dist file' => array(
                ...
                'The bootstrap file "fixtures/invalid/missing.yml.bootstrap" does not exist. Check your bootstrap-file config or create it.',
            ),
            'missing custom dist file' => array(
                ...
                'The bootstrap file "fixtures/invalid/non-existent.bootstrap.yml" does not exist. Check your bootstrap-file config or create it.',
            ),
